...
class MnistModel(BaseModel):
    # extending from nn.Module class
    """ 
    ...
    def __init__(self):
        ...
        self.fc2 = nn.Linear(in_features=128, out_features=10)  # MNIST labels 0 ~ 9
    ...
    def forward(self, x):
        ...
        x = torch.flatten(
            x, start_dim=1
        )  # using torch's function: https://pytorch.org/docs/stable/generated/torch.flatten.html
